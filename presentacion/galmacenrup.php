      ...
      <div class="container">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
            ...
            <a class="navbar-brand" href="#"><div class="label label-danger"><?php $v = $_GET["ta"]; echo $v;?><?php $tp = $_GET["tp"]; echo ' - '.$tp;?><?php $a = $_GET["variable1"]; echo ' - Almacen '.$a;?><?php $z = $_GET["z"]; echo ' - '.$z;?><?php $r = $_GET["r"]; echo ' - '.$r;?></div></a>
        </div>
       ...
       <div id="contenido" class="container" >
           <?php
            ...
            $objkardex->listar($pagina_actual,$ta,$tp,$r,$z,$a);
